...
# ----------------------------
# Distance estimation (monocular, using known target width)
# ----------------------------
KNOWN_TARGET_WIDTH_CM = 6.5      # <-- set to your real target width
CALIB_DISTANCE_CM = 50.0         # <-- distance you will calibrate at (ruler measure)
